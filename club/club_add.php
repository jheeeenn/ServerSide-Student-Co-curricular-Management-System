...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (isset($_POST['submit'])) {
        ...
        if (empty($errors)) {
            $query = "INSERT INTO clubs (user_id, club_name, role, join_date, description) 
                      VALUES ('$user_id', '$club_name', '$role', '$join_date', '$description')";
...
<div class="container">
    <div class="form-card">
        ...
        <h2 style="color: var(--text-primary); font-weight: 800; margin-top: 0; font-size: 26px;">Add New Club</h2>
        <p style="color: var(--text-secondary); margin-bottom: 35px; font-size: 14px;">Register a new co-curricular affiliation to your portfolio.</p>
        ...
        <form method="POST" action="">
            <div class="form-row">
                <div class="form-group">
                    ...
                    <div class="input-wrapper">
                        <input type="text" name="club_name" class="form-input" placeholder="e.g., Chess Club" maxlength="100" required>
                ...
                <div class="form-group">
                    ...
                    <div class="input-wrapper">
                        <input type="text" name="role" class="form-input" placeholder="e.g., Committee Member" maxlength="50" required>
            ...
            <div class="form-group full-width">
                ...
                <div class="input-wrapper">
                    <input type="date" name="join_date" class="form-input" style="color-scheme: <?php echo $theme; ?>;" max="<?php echo date('Y-m-d'); ?>" min="<?php echo date('Y', strtotime('-10 years')) . '-01-01'; ?>" required>
            ...
            <div class="form-group full-width">
                ...
                <textarea name="description" class="form-input" placeholder="Briefly describe your activities or motto..." maxlength="1000"></textarea>
            </div>
